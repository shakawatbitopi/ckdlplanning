$(function () {
    ...
    $(document).delegate('#ddlPRID', 'change', function (e) {
        e.preventDefault();
        LoadPREfficiency($(this).val());
    });

    $(document).delegate('#txtWorkStation', 'keyup', function (e) {
        e.preventDefault();
        CalculateDailyTarget($(this).val());
    });
...
function LoadMasterData() {
    $.ajax({
        type: "POST",
        url: baseURL + "/EfficeincyMatrix/LoadAllActivePR",
        data: {},
    ...
    $('#ddlPRID').selectpicker('refresh');
    $('#ddlPRID').selectpicker('render');
}
function LoadPREfficiency(PRMasterID) {
...
function PopulateEfficiencyData(data) {
    ...
    $("#divEfficiencyMatrix").kendoGrid({
        ...
        toolbar: "<a id='btnUpdateData' role='button' class='k-button k-button-icontext k-grid-edit' href='javascript:void(0)'><span class='k-icon k-i-check'></span>Update Data</a>" +
            ...
            //"<input id='txtStartDay' type='text' class='k-textbox' placeholder='From Day No..' style='width: 100px;' />" +
            //"<input id='txtEndDay' type='text' class='k-textbox' placeholder='End Day No..' style='width: 100px;' />" +
            //"<input id='txtEfficiency' type='text' class='k-textbox' placeholder='End Day No..' style='width: 100px;' />" +
            //"<input id='txtQuantity' type='text' class='k-textbox' placeholder='End Day No..' style='width: 100px;' />" +
            //"<a id='btnUpdateEfficiency' role='button' class='k-button k-button-icontext k-grid-edit' href='javascript:void(0)'><span class='k-icon k-i-download'></span>Update</a>" +
